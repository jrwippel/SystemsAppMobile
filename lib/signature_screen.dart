   ...
   final url = Uri.parse('${ConfigService.apiBaseUrl}/ApiPedidos/UploadFotoPedido');
    try {
      ...
      if (motoristaSignature != null && clienteSignature != null) {
        ...
        request.fields['NomeFoto'] = 'motorista_signature.png';
        ...
        requestCliente.fields['NomeFoto'] = 'cliente_signature.png';
        requestCliente.fields['TipoFotoPedido'] = '1'; // 1 = Carga, 2 = Descarga
